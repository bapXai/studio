...
export const LoginModal = ({
  open,
  onClose,
  title = "Log In to use bapXcode for free",
  description = "Log In through your Hugging Face account to continue using bapXcode and increase your monthly free limit.",
  prompt,
}: {
  open: boolean;
