...
export const ProModal = ({
  ...
  const handleProClick = () => {
    ...
    window.open("https://huggingface.co/subscribe/pro?from=bapXcode", "_blank");
    onClose(false);
  };
  return (
      ...
      >
        ...
        <main className="flex flex-col items-start text-left relative pt-2">
          ...
          <p className="text-neutral-500 text-base mt-2 max-w-sm">
            It seems like you have reached the monthly free limit of bapXcode.
          </p>
