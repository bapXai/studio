...
export const AskAi = ({
  ...
  const [enhancedSettings, setEnhancedSettings, removeEnhancedSettings] =
    useLocalStorage<EnhancedSettings>("bapxcode-enhancedSettings", {
      isActive: false,
  ...
  return (
    <div className="p-3 w-full">
      <div className="relative bg-neutral-800 border border-neutral-700 rounded-2xl ring-[4px] focus-within:ring-neutral-500/30 focus-within:border-neutral-600 ring-transparent z-20 w-full group">
          ...
          <div className="w-full border-b border-neutral-700 relative overflow-hidden">
            ...
            >
              <p className="text-sm font-medium text-neutral-300 group-hover:text-neutral-200 transition-colors duration-200">
                {isThinking ? "bapXcode is thinking..." : "bapXcode's plan"}
              </p>
              <ChevronDown
        ...
        <div className="w-full relative flex items-center justify-between">
          ...
          <textarea
            ...
            placeholder={
              selectedElement
                ? `Ask bapXcode about ${selectedElement.tagName.toLowerCase()}...`
                : redesignData
                ? "Ask bapXcode anything about the redesign of your site..."
                : isFollowUp && (!isSameHtml || pages?.length > 1)
                ? "Ask bapXcode for edits"
                : "Ask bapXcode anything..."
            }
            value={prompt}
      ...
      <audio ref={hookAudio} id="audio" className="hidden">
        <source src="/bapxcode/success.mp3" type="audio/mpeg" />
