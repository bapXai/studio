...
export async function generateMetadata({
  ...
  return generateSEO({
    title: `${namespace}/${repoId} - bapXcode Editor`,
    description: `Edit and build ${namespace}/${repoId} with AI-powered tools on bapXcode. Create stunning websites with no code required.`,
