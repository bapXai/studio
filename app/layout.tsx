...
export const metadata: Metadata = {
  ...generateSEO({
    ...
    description:
      "bapXcode is a web development tool that helps you build websites with AI, no code required. Let's deploy your website with bapXcode and enjoy the magic of AI.",
    path: "/",
  }),
  appleWebApp: {
    capable: true,
...
export default async function RootLayout({
  ...
  if (!isHuggingFace && !isLocalDev) {
    const pathname = headersList.get("x-invoke-path") || "/bapxcode";
